...
public class NewsCard {
    ...
    public void NewsCardResponse(String title, String description, String imageUrl, String button1, String button2, String button3, String url1, String url2, String url3) {
        this.title = title;
